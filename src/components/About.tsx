...
const About: React.FC = () => {
  return (
    <section id="about" className="max-w-5xl mx-auto px-6 py-16">
      <h2 className="text-3xl font-bold mb-8 border-b-2 border-gray-300 pb-2 w-fit">About Me</h2>
      <div className="grid grid-cols-1 md:grid-cols-5 gap-12 items-start">
        <div className="md:col-span-3 text-base text-gray-700">
          <p className="mb-4">
            ...
            tweaking a process until it just works. I`&apos;`m curious by nature, quietly
        ...
        <div className="md:col-span-2 max-w-xs mx-auto md:mx-0">
          <div className="relative group">
            <div className="rounded-lg overflow-hidden bg-teal-500 shadow-lg transform group-hover:-translate-x-1 group-hover:-translate-y-1 transition-transform"></div>
            <div className="absolute top-3.5 left-3.5 w-full h-full border-2 border-teal-500 rounded-lg z-[-1] transition-transform group-hover:translate-x-2 group-hover:translate-y-2"></div>
          </div>
        </div>
      </div>
    </section>
